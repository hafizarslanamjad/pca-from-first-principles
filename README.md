...
| 16. Why the covariance matrix exists | [A feature-by-feature relationship table](lectures/16-why-covariance-matrix-exists/index.qmd) | [Typed covariance table and matrix verification](examples/16_why_covariance_matrix_exists.py) |
...
Lecture 16 constructs the covariance matrix from feature-pair questions, explains its symmetry and axes, and derives the centered matrix product. Its typed companion verifies the pairwise calculations against the matrix expression.
